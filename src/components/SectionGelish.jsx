...
<>
      <Link to=""> 
      <img src={imagen.url} alt="" className='h-full img hover:scale-75 ease-in duration-300 rounded-lg' onClick={() => {
        setOpen(true)
    }}/>     
      </Link>
