const Aplicacion3D = ({ title, active, setActive }) => {
  return (
    <div className=" max-w-xl text-white py-1">
      ...
      >
        <div className="p-5 text-lg text-black">
          <p>
          El efecto en 3d es de los efectos en tendencia, en los cuales se realizan flores, frutas, texturas, etc.
          </p>
        </div>
      </div>
    </div>
